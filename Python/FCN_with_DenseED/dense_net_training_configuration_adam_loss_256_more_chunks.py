...
ckpt_dir = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/1803/more_chunks/'
#train function
...
def train(epochs):
    ...
    np.savetxt(path+'/DenseED_train_RMSE_1803_2021_'+timestr_plt+'.txt', np.array(mse_loss_train))
    np.savetxt(path+'/DenseED_test_RMSE_1803_2021_'+timestr_plt+'.txt', np.array(mse_loss_test))
    # save model
    torch.save(model.state_dict(), ckpt_dir + "/DenseED_model_epoch{}.pth".format(epoch))
    torch.save(model,ckpt_dir+'DenseED_model_SR_1803_2021_'+timestr_plt+'.pt')
    #plots 
    ...
    plt.savefig(path+'/DenseED_RMSE_loss_1803_2021_'+timestr_plt+'.png')
