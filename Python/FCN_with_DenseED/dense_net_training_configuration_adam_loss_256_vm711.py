...
test_type = 1
CSV_path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Feb21/0602/SR_training/vm711/'
...
im_height = 128 #M
im_width = 128  #N
num_exps_train = 400 #total train examples = 57000 we are using all FOV 9 to 16 here which is 8*50 = 400 images + FOV from 1-7 also (7*50 = 350)
...
ckpt_dir = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Feb21/0602/SR_training/vm711/saved_model/'
#train function
...
if __name__ == "__main__":
    ...
    path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Feb21/0602/SR_training/vm711/'
