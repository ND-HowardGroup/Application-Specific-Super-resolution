...
def train(epochs):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (noisy, clean) in enumerate(dataloader_test):
            ...
            import imageio
            imageio.imwrite('unet_bn_DL_image1.tif', noisy_full)
            imageio.imwrite('unet_bn_target_SR_image1.tif', clean_full)
            imageio.imwrite('unet_bn_Est_SR_image1.tif', denoised_full)
