...
test_type = 1
CSV_path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/1203/learning_rates/lr1/'
...
ckpt_dir = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/1203/learning_rates/lr1/'
#train function
...
def train(epochs):
    ...
    np.savetxt(path+'/DenseED_train_RMSE_1203_2021_'+timestr_plt+'.txt', np.array(mse_loss_train))
    np.savetxt(path+'/DenseED_test_RMSE_1203_2021_'+timestr_plt+'.txt', np.array(mse_loss_test))
    # save model
    torch.save(model.state_dict(), ckpt_dir + "/DenseED_model_epoch{}.pth".format(epoch))
    torch.save(model,ckpt_dir+'DenseED_model_SR_1203_2021_'+timestr_plt+'.pt')
    #plots 
    ...
    plt.savefig(path+'/DenseED_RMSE_loss_1203_2021_'+timestr_plt+'.png')

if __name__ == "__main__":
    #Trainer(default_save_path=’/your/path/to/save/checkpoints’)
    path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/1203/learning_rates/lr1/'
