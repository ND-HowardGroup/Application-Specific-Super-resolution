...
test_type = 1
CSV_path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/2303/inference_diff_sample/'
class DataGenerator(data.Dataset):
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        if self.train == False and self.validation == False and self.test == True:
            if self.test_type == 1:
                df = pandas.read_csv(CSV_path + 'samples_test_inference_short_MK.csv')
            if self.test_type == 2:
...
ckpt_dir = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/2303/inference_diff_sample/DenseED_model_SR_1203_2021_20210316_165926.pt'
...
def train(epochs):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (noisy, clean) in enumerate(dataloader_test):
            ...
            #import Image
            imageio.imwrite('DL_image_MK.tif', noisy_full)
            imageio.imwrite('target_SR_image_MK.tif', clean_full)
            imageio.imwrite('Est_SR_image_MK.tif', denoised_full)
            #im1 = Image.fromarray(noisy_full)
            # im1.save('DL_image_MK.tif')
#             im2 = Image.fromarray(clean_full)
#             im2.save('target_SR_image_MK.tif')
#             im3 = Image.fromarray(denoised_full)
#             im3.save('Est_SR_image_MK.tif')
...
if __name__ == "__main__":
    ...
    path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Spring21/Mar21/2303/inference_diff_sample/'
